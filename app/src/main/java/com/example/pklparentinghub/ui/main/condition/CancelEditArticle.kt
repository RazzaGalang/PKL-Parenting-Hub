...
class CancelEditArticle : DialogFragment () {
    ...
    private fun setOutput(){
        ...
        binding.apply {
            ...
            registerConditionContent.text = "Artikel yang diedit tidak akan disimpan"
            ...
            registerConditionButton2.text = "Lanjutkan Mengedit"
        }
    }
