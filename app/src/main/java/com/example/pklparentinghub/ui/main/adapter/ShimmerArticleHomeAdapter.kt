...
class ShimmerArticleHomeAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = inflater.inflate(R.layout.item_shimmer_article_home, parent, false)
